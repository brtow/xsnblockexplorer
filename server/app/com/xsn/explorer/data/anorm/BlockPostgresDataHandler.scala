...
import com.xsn.explorer.data.BlockDataHandler
...
class BlockPostgresDataHandler @Inject() (
    ...
    extends BlockDataHandler[ApplicationResult]
    with AnormPostgresDataHandler {

  def create(block: Block): ApplicationResult[Block] = database.withConnection { implicit conn =>
